...
const statements = [
  ...
  `CREATE TABLE IF NOT EXISTS ai_web_chat_events (
    id bigint NOT NULL AUTO_INCREMENT,
    request_id varchar(96) NOT NULL,
    ...
    created_at bigint NOT NULL,
    PRIMARY KEY (id),
    KEY idx_ai_web_chat_events_request_id (request_id, id),
    KEY idx_ai_web_chat_events_created_at (created_at)
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci`,
  `CREATE TABLE IF NOT EXISTS ai_web_writing_plans (
    id varchar(96) NOT NULL,
  ...
  `CREATE TABLE IF NOT EXISTS ai_web_writing_checkins (
    id varchar(96) NOT NULL,
